...
class ModernSidebar(QWidget):
    ...
    def setup_ui(self):
        ...
        # Logo/brand area
        self.brand_label = QLabel("AI-ARTWORK")
...
class ModernMainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle("AI-ARTWORK - Advanced AI Image System")
...
def create_modern_app() -> QApplication:
    ...
    app.setApplicationName("AI-ARTWORK")
    app.setApplicationVersion("1.0.0")
    app.setOrganizationName("AI-ARTWORK Team")
