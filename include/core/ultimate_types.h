 ...
 * @date 2024
 * 
 * Core type definitions for the ULTIMATE Windows system.
 */
...
typedef enum {
    ULTIMATE_WINDOW_EVENT_CLOSE = 0,
    ULTIMATE_WINDOW_EVENT_RESIZE,
    ULTIMATE_WINDOW_EVENT_KEY_PRESS,
    ULTIMATE_WINDOW_EVENT_MOUSE_MOVE,
    ULTIMATE_WINDOW_EVENT_MOUSE_CLICK
} ultimate_window_event_t;
...
typedef struct ultimate_window* ultimate_window_handle_t;
